...
public class RequestServletModule extends ServletModule {
    ...
    private void bindAPI() {
        ...
        this.bindClassesAnnotatedWithInPackage("nl.tudelft.planningstool.api", ManagedService.class);
        this.bindClassesAnnotatedWithInPackage("nl.tudelft.planningstool.core.mappers", Provider.class);
        this.bindClassesAnnotatedWithInPackage("nl.tudelft.planningstoolgit .api.filters", Provider.class);
    }
